...
(function(){
  ...
  var CH = [
    ...
    {id:'douze-notions.html',          g:['Repères','References'],         t:['12 notions clés','12 key notions']}
  ];
  var L = isEN ? 1 : 0;
  ...
  var UI = isEN
    ? {home:'Home', som:'Contents', glo:'Glossary', prev:'Previous', next:'Next', end:'Finish', endt:'Contents'}
    : {home:'Accueil', som:'Sommaire', glo:'Glossaire', prev:'Précédent', next:'Suivant', end:'Fin', endt:'Le sommaire'};
